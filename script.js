...
function refreshOnce() {
    localStorage.getItem("reload") ? localStorage.removeItem("reload") : ($("body").remove(), localStorage.setItem("reload", "true"), setTimeout(function () {
        location.reload()
    }, 500))
}
...
function invertHorScroll() {
    var e = $(".projects-list");
    is_touch_device() || $(e).mousewheel(function (t, n) {
        t.preventDefault();
        var r = $(e).scrollLeft();
        $(e).scrollLeft(r - n)
    })
...
function animateProjectClose(e, t) {
    anime.timeline({}).add({
        ...
        complete: function () {
            $(".closing").removeClass("show-close"), $.ajax({
                url: t,
                success: function (e) {
...
function loadedVideo(e, t) {
    $(t).attr("controls", !1), $(e).hasClass("canplay") || $(t).on("loadeddata", function () {
...
function playVideo(e, t, n) {
    if (!$(e).hasClass("playing")) {
        ...
        void 0 !== r && r.then(function () {
            $(e).addClass("playing").removeClass("paused"), $(t).get(0).play(), $(n).css({
                opacity: 0
            })
        }).catch(function (r) {
            $(e).removeClass("playing").addClass("paused"), $(t).get(0).pause(), $(n).css({
                opacity: 1
            })
        })
    }
...
function initPlayers() {
    $(".video-container").each(function () {
        ...
        $(this).find("video-bg");
        insertFakePoster($(this)), loadedVideo($(this), e)
    })
}
...
function onScroll() {
    whenOnScreen($(".projects-list").scrollLeft()), $(".projects-list").on("scroll", function () {
...
function loadProject(e, t) {
    $.ajax({
        ...
        complete: function (e) {
            animateOpenedProject(".loading .project__medias .project__media", 0, 0), scrollToProjects(".loading"), $(".projects-list__item").removeClass("loading")
        }
    })
}
...
function openProject() {
    $(document).on("click", ".projects-list__item:not(.opened)", function () {
        var e = $(this).data("url");
        $(this).addClass("opened loading"), loadProject($(this).find(".projects-list__content"), e), history.replaceState({}, "New URL: ", e)
    })
}
...
function closeProject() {
    $(document).on("click", ".projects-list__item.opened .btn__switch", function () {
        ...
        $(e).addClass("closing"), animateProjectClose(".closing .project__medias .project__media", t, $(".closing .project__medias .project__media").length - 1), $(e).removeClass("opened"), scrollToProjects($(e)), history.replaceState({}, "New URL: ", t)
    })
}

function setItemWidth(e) {
    $(e).each(function () {
        if ($(this).hasClass("project__media")) var e = $(this),
            t = $(this).parents(".projects-list__item"),
            n = $(t).height();
        else e = $(this).find(".project__media"), n = $(this).height();
        var r = $(e).data("width") * (n - 45) / $(e).data("height");
        r + 15, $(this).hasClass("project__media") && $(this).parents(".loading").length ? $(e).attr("data-final", r + "px") : $(e).css("width", r + "px")
    })
}

function handleProject() {
    openProject(), closeProject(), setItemWidth(".projects-list__item"), setItemWidth(".project__medias .project__media"), setProjectScrollbar(), $(window).on("resize", function () {
...
function setProjectScrollbar() {
    ...
    $(".projects-list__content > .project__media").each(function () {
        ...
        o += e
    }), o -= 15, $(".project__medias .project__media").each(function () {
        var e = $(this),
            t = $(this).parents(".projects-list__item"),
            n = $(t).height(),
            r = $(e).data("width"),
...
function updateTime() {
    ...
    var j = function (e) {
        var t, n, r, o, i, a, s, u, c, l, f, d, p, h, g, m, v, y, x, b = "sizzle" + 1 * new Date,
            w = e.document,
            T = 0,
            C = 0,
            j = ue(),
        ...
        for (t in n = se.support = {}, i = se.isXML = function (e) {
                ...
                return a !== p && 9 === a.nodeType && a.documentElement && (h = (p = a).documentElement, g = !i(p), w !== p && (o = p.defaultView) && o.top !== o && (o.addEventListener ? o.addEventListener("unload", ie, !1) : o.attachEvent && o.attachEvent("onunload", ie)), n.attributes = le(function (e) {
                ...
                }), m = m.length && new RegExp(m.join("|")), v = v.length && new RegExp(v.join("|")), t = Z.test(h.compareDocumentPosition), x = t || Z.test(h.contains) ? function (e, t) {
                    ...
                    return r || (1 & (r = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || !n.sortDetached && t.compareDocumentPosition(e) === r ? e === p || e.ownerDocument === w && x(w, e) ? -1 : t === p || t.ownerDocument === w && x(w, t) ? 1 : l ? P(l, e) - P(l, t) : 0 : 4 & r ? -1 : 1)
                } : function (e, t) {
                    if (e === t) return f = !0, 0;
                    var n, r = 0,
                        o = e.parentNode,
                        ...
                        return 1 === r && 0 === o ? function (e) {
                            ...
                            if (m) {
                                ...
                                if (h = [a ? m.firstChild : m.lastChild], a && y) {
                                    for (x = (p = (c = (l = (f = (d = m)[b] || (d[b] = {}))[d.uniqueID] || (f[d.uniqueID] = {}))[e] || [])[0] === T && c[1]) && c[2], d = p && m.childNodes[p]; d = ++p && d && d[g] || (x = p = 0) || h.pop();)
                                        if (1 === d.nodeType && ++x && d === t) {
                                            l[e] = [T, p, x];
                                            break
                                        }
                                } else if (y && (x = p = (c = (l = (f = (d = t)[b] || (d[b] = {}))[d.uniqueID] || (f[d.uniqueID] = {}))[e] || [])[0] === T && c[1]), !1 === x)
                                    for (;
                                        (d = ++p && d && d[g] || (x = p = 0) || h.pop()) && ((s ? d.nodeName.toLowerCase() !== v : 1 !== d.nodeType) || !++x || (y && ((l = (f = d[b] || (d[b] = {}))[d.uniqueID] || (f[d.uniqueID] = {}))[e] = [T, x]), d !== t)););
                ...
                if (n = r.relative[e[u].type]) d = [be(we(d), n)];
                    ...
                    if ((n = r.filter[e[u].type].apply(null, e[u].matches))[b]) {
                        ...
                        return Ce(1 < u && we(d), 1 < u && xe(e.slice(0, u - 1).concat({
                            value: " " === e[u - 2].type ? "*" : ""
                        })).replace(F, "$1"), n, u < o && je(e.slice(u, o)), o < i && je(e = e.slice(o)), o < i && xe(e))
                    }
                    d.push(n)
                } return we(d)
        }
        return ye.prototype = r.filters = r.pseudos, r.setFilters = new ye, a = se.tokenize = function (e, t) {
            ...
            if (n = n || [], 1 === p.length) {
                if (2 < (u = p[0] = p[0].slice(0)).length && "ID" === (c = u[0]).type && 9 === t.nodeType && g && r.relative[u[1].type]) {
    ...
    w.find = j, w.expr = j.selectors, w.expr[":"] = w.expr.pseudos, w.uniqueSort = w.unique = j.uniqueSort, w.text = j.getText, w.isXMLDoc = j.isXML, w.contains = j.contains, w.escapeSelector = j.escape;
    ...
    w.fn.extend({
        ...
        w.fn[e] = function (n, r) {
            ...
            return "Until" !== e.slice(-5) && (r = n), r && "string" == typeof r && (o = w.filter(r, o)), 1 < this.length && (O[e] || w.uniqueSort(o), M.test(e) && o.reverse()), this.pushStack(o)
        }
    });
    var q = /[^\x20\t\r\n\f]+/g;
    ...
    w.Callbacks = function (e) {
                ...
                o = {
                    ...
                    then: function (t, r, o) {
                                ...
                                var s = this,
                                    ...
                                    c = function () {
                                        ...
                                        if (!(t < i)) {
                                            ...
                                            c = e && ("object" == typeof e || "function" == typeof e) && e.then, g(c) ? o ? c.call(e, a(i, n, _, o), a(i, n, H, o)) : (i++, c.call(e, a(i, n, _, o), a(i, n, H, o), a(i, n, _, n.notifyWith))) : (r !== _ && (s = void 0, u = [e]), (o || n.resolveWith)(s, u))
                                        }
                                    },
                                    l = o ? c : function () {
                                        try {
                                            ...
                                            w.Deferred.exceptionHook && w.Deferred.exceptionHook(e, l.stackTrace), i <= t + 1 && (r !== H && (s = void 0, u = [e]), n.rejectWith(s, u))
                                        }
                                    };
                        ...
                        return w.Deferred(function (e) {
                            n[0][3].add(a(0, e, g(o) ? o : _, e.notifyWith)), n[1][3].add(a(0, e, g(t) ? t : _)), n[2][3].add(a(0, e, g(r) ? r : H))
                        }).promise()
                    },
                    promise: function (e) {
        ...
        when: function (e) {
            ...
            if (t <= 1 && (I(e, a.done(s(n)).resolve, a.reject, !t), "pending" === a.state() || g(o[n] && o[n].then))) return a.then();
    ...
    }), w.ready.then = B.then, "complete" === r.readyState || "loading" !== r.readyState && !r.documentElement.doScroll ? e.setTimeout(w.ready) : (r.addEventListener("DOMContentLoaded", F), e.addEventListener("load", F));
    ...
    function ce(e, t, n, r) {
        ...
        if (l && l[3] !== c) {
            for (u /= 2, c = c || l[3], l = +u || 1; a--;) w.style(e, t, l + c), (1 - i) * (1 - (i = s() / u || .5)) <= 0 && (a = 0), l /= i;
    ...
    function fe(e, t) {
        for (var n, r, o, i, a, s, u, c = [], l = 0, f = e.length; l < f; l++)(r = e[l]).style && (n = r.style.display, t ? ("none" === n && (c[l] = G.get(r, "display") || null, c[l] || (r.style.display = "")), "" === r.style.display && se(r) && (c[l] = (u = a = i = void 0, a = (o = r).ownerDocument, s = o.nodeName, (u = le[s]) || (i = a.body.appendChild(a.createElement(s)), u = w.css(i, "display"), i.parentNode.removeChild(i), "none" === u && (u = "block"), le[s] = u)))) : "none" !== n && (c[l] = "none", G.set(r, "display", n)));
    ...
    function we(e, t, n, r, o) {
        for (var i, a, s, u, c, l, f = t.createDocumentFragment(), d = [], p = 0, h = e.length; p < h; p++)
            ...
            for (a = a || f.appendChild(t.createElement("div")), s = (pe.exec(i) || ["", ""])[1].toLowerCase(), u = ge[s] || ge._default, a.innerHTML = u[1] + w.htmlPrefilter(i) + u[2], l = u[0]; l--;) a = a.lastChild;
        ...
        n ? (G.set(e, t, !1), w.event.add(e, t, {
            ...
            handler: function (e) {
                ...
                if (1 & e.isTrigger && this[t]) {
                    ...
                    else if (a = i.call(arguments), G.set(this, t, a), r = n(this, t), this[t](), a !== (o = G.get(this, t)) || r ? G.set(this, t, !1) : o = void 0, a !== o) return e.stopImmediatePropagation(), e.preventDefault(), o
                } else a && (G.set(this, t, w.event.trigger(w.extend(a.shift(), w.Event.prototype), a, this)), e.stopImmediatePropagation())
            }
        })) : w.event.add(e, t, Se)
    }
    w.event = {
        ...
        add: function (e, t, n, r, o) {
            var i, a, s, u, c, l, f, d, p, h, g, m = G.get(e);
            if (m)
                for (n.handler && (n = (i = n).handler, o = i.selector), o && w.find.matchesSelector(oe, o), n.guid || (n.guid = w.guid++), (u = m.events) || (u = m.events = {}), (a = m.handle) || (a = m.handle = function (t) {
                        return void 0 !== w && w.event.triggered !== t.type ? w.event.dispatch.apply(e, arguments) : void 0
                    }), c = (t = (t || "").match(q) || [""]).length; c--;) p = g = (s = je.exec(t[c]) || [])[1], h = (s[2] || "").split(".").sort(), p && (f = w.event.special[p] || {}, p = (o ? f.delegateType : f.bindType) || p, f = w.event.special[p] || {}, l = w.extend({
                    type: p,
                    origType: g,
                    data: r,
                    handler: n,
                    ...
                    namespace: h.join(".")
                }, i), (d = u[p]) || ((d = u[p] = []).delegateCount = 0, f.setup && !1 !== f.setup.call(e, r, h, a) || e.addEventListener && e.addEventListener(p, a)), f.add && (f.add.call(e, l), l.handler.guid || (l.handler.guid = n.guid)), o ? d.splice(d.delegateCount++, 0, l) : d.push(l), w.event.global[p] = !0)
        },
        remove: function (e, t, n, r, o) {
            var i, a, s, u, c, l, f, d, p, h, g, m = G.hasData(e) && G.get(e);
            if (m && (u = m.events)) {
                for (c = (t = (t || "").match(q) || [""]).length; c--;)
                    if (p = g = (s = je.exec(t[c]) || [])[1], h = (s[2] || "").split(".").sort(), p) {
                        for (f = w.event.special[p] || {}, d = u[p = (r ? f.delegateType : f.bindType) || p] || [], s = s[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), a = i = d.length; i--;) l = d[i], !o && g !== l.origType || n && n.guid !== l.guid || s && !s.test(l.namespace) || r && r !== l.selector && ("**" !== r || !l.selector) || (d.splice(i, 1), l.selector && d.delegateCount--, f.remove && f.remove.call(e, l));
                        a && !d.length && (f.teardown && !1 !== f.teardown.call(e, h, m.handle) || w.removeEvent(e, p, m.handle), delete u[p])
                    } else
                        for (p in u) w.event.remove(e, p + t[c], n, r, !0);
            ...
            if (u && c.nodeType && !("click" === e.type && 1 <= e.button))
                for (; c !== this; c = c.parentNode || this)
                    if (1 === c.nodeType && ("click" !== e.type || !0 !== c.disabled)) {
                        for (i = [], a = {}, n = 0; n < u; n++) void 0 === a[o = (r = t[n]).selector + " "] && (a[o] = r.needsContext ? -1 < w(o, this).index(c) : w.find(o, this, null, [c]).length), a[o] && i.push(r);
                        i.length && s.push({
                            elem: c,
                            handlers: i
                        })
    ...
    function He(e, t, n, r) {
        ...
        var o, i, s, u, c, l, f = 0,
            ...
            m = t[0],
            v = g(m);
        if (v || 1 < d && "string" == typeof m && !h.checkClone && Le.test(m)) return e.each(function (o) {
            var i = e.eq(o);
            v && (t[0] = m.call(this, o, i.html())), He(i, t, n, r)
        });
        if (d && (i = (o = we(t, e[0].ownerDocument, !1, e, r)).firstChild, 1 === o.childNodes.length && (o = i), i || r)) {
            for (u = (s = w.map(me(o, "script"), Pe)).length; f < d; f++) c = o, f !== p && (c = w.clone(c, !0, !0), u && w.merge(s, me(c, "script"))), n.call(e[f], c, f);
            if (u)
                for (l = s[s.length - 1].ownerDocument, w.map(s, qe), f = 0; f < u; f++) c = s[f], he.test(c.type || "") && !G.access(c, "globalEval") && w.contains(l, c) && (c.src && "module" !== (c.type || "").toLowerCase() ? w._evalUrl && !c.noModule && w._evalUrl(c.src, {
    ...
    w.extend({
        ...
        clone: function (e, t, n) {
            ...
            if (!(h.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || w.isXMLDoc(e)))
                for (a = me(l), r = 0, o = (i = me(e)).length; r < o; r++) s = i[r], "input" === (c = (u = a[r]).nodeName.toLowerCase()) && de.test(s.type) ? u.checked = s.checked : "input" !== c && "textarea" !== c || (u.defaultValue = s.defaultValue);
            if (t)
                if (n)
                    for (i = i || me(e), a = a || me(l), r = 0, o = i.length; r < o; r++) _e(i[r], a[r]);
                else _e(e, l);
    ...
    function We(e, t, n) {
        ...
        return (n = n || Be(e)) && ("" !== (a = n.getPropertyValue(t) || n[t]) || ie(e) || (a = w.style(e, t)), !h.pixelBoxStyles() && Re.test(a) && Fe.test(t) && (r = s.width, o = s.minWidth, i = s.maxWidth, s.minWidth = s.maxWidth = s.width = a, a = n.width, s.width = r, s.minWidth = o, s.maxWidth = i)), void 0 !== a ? a + "" : a
    }
    ...
    function ze(e, t) {
        ...
        function t() {
            if (l) {
                ...
                o = "1%" !== t.top, u = 12 === n(t.marginLeft), l.style.right = "60%", s = 36 === n(t.right), i = 36 === n(t.width), l.style.position = "absolute", a = 12 === n(l.offsetWidth / 3), oe.removeChild(c), l = null
            }
        }
        ...
        var o, i, a, s, u, c = r.createElement("div"),
        ...
        style: function (e, t, n, r) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var o, i, a, s = V(t),
                    u = Ge.test(t),
                    c = e.style;
                if (u || (t = Ye(s)), a = w.cssHooks[t] || w.cssHooks[s], void 0 === n) return a && "get" in a && void 0 !== (o = a.get(e, !1, r)) ? o : c[t];
                "string" == (i = typeof n) && (o = ne.exec(n)) && o[1] && (n = ce(e, t, o), i = "number"), null != n && n == n && ("number" !== i || u || (n += o && o[3] || (w.cssNumber[s] ? "" : "px")), h.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (c[t] = "inherit"), a && "set" in a && void 0 === (n = a.set(e, n, r)) || (u ? c.setProperty(t, n) : c[t] = n))
            }
        },
        css: function (e, t, n, r) {
            var o, i, a, s = V(t);
            return Ge.test(t) || (t = Ye(s)), (a = w.cssHooks[t] || w.cssHooks[s]) && "get" in a && (o = a.get(e, !0, n)), void 0 === o && (o = We(e, t, r)), "normal" === o && t in Ze && (o = Ze[t]), "" === n || n ? (i = parseFloat(o), !0 === n || isFinite(i) ? i || 0 : o) : o
        }
    }), w.each(["height", "width"], function (e, t) {
        w.cssHooks[t] = {
            get: function (e, n, r) {
                if (n) return !Qe.test(w.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? tt(e, t, r) : ue(e, Je, function () {
                    return tt(e, t, r)
                })
            },
            set: function (e, n, r) {
                var o, i = Be(e),
                    ...
                    u = r ? et(e, t, r, s, i) : 0;
                return s && a && (u -= Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - parseFloat(i[t]) - et(e, t, "border", !1, i) - .5)), u && (o = ne.exec(n)) && "px" !== (o[3] || "px") && (e.style[t] = n, n = w.css(e, t)), Ke(0, n, u)
            }
        }
    ...
    function pt(e, t, n) {
        ...
        for (function (e, t) {
            ...
            if (r = pt.prefilters[i].call(c, e, l, c.opts)) return g(r.stop) && (w._queueHooks(c.elem, c.opts.queue).stop = r.stop.bind(r)), r;
        return w.map(l, dt, c), g(c.opts.start) && c.opts.start.call(e, c), c.progress(c.opts.progress).done(c.opts.done, c.opts.complete).fail(c.opts.fail).always(c.opts.always), w.fx.timer(w.extend(u, {
            elem: e,
            anim: c,
            queue: c.opts.queue
        })), c
    ...
    w.Animation = w.extend(pt, {
        ...
        prefilters: [function (e, t, n) {
            ...
            for (r in n.queue || (null == (a = w._queueHooks(e, "fx")).unqueued && (a.unqueued = 0, s = a.empty.fire, a.empty.fire = function () {
                ...
                for (r in f && 1 === e.nodeType && (n.overflow = [h.overflow, h.overflowX, h.overflowY], null == (c = m && m.display) && (c = G.get(e, "display")), "none" === (l = w.css(e, "display")) && (c ? l = c : (fe([e], !0), c = e.style.display || c, l = w.css(e, "display"), fe([e]))), ("inline" === l || "inline-block" === l && null != c) && "none" === w.css(e, "float") && (u || (d.done(function () {
                        h.display = c
    ...
    w.extend(w.event, {
        trigger: function (t, n, o, i) {
            ...
            if (s = h = u = o = o || r, 3 !== o.nodeType && 8 !== o.nodeType && !Tt.test(y + w.event.triggered) && (-1 < y.indexOf(".") && (y = (x = y.split(".")).shift(), x.sort()), l = y.indexOf(":") < 0 && "on" + y, (t = t[w.expando] ? t : new w.Event(y, "object" == typeof t && t)).isTrigger = i ? 2 : 3, t.namespace = x.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + x.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = o), n = null == n ? [t] : w.makeArray(n, [t]), p = w.event.special[y] || {}, i || !p.trigger || !1 !== p.trigger.apply(o, n))) {
                ...
                for (a = 0;
                    (s = v[a++]) && !t.isPropagationStopped();) h = s, t.type = 1 < a ? c : p.bindType || y, (d = (G.get(s, "events") || {})[t.type] && G.get(s, "handle")) && d.apply(s, n), (d = l && s[l]) && d.apply && Y(s) && (t.result = d.apply(s, n), !1 === t.result && t.preventDefault());
                return t.type = y, i || t.isDefaultPrevented() || p._default && !1 !== p._default.apply(v.pop(), n) || !Y(o) || l && g(o[y]) && !m(o) && ((u = o[l]) && (o[l] = null), w.event.triggered = y, t.isPropagationStopped() && h.addEventListener(y, Ct), o[y](), t.isPropagationStopped() && h.removeEventListener(y, Ct), w.event.triggered = void 0, u && (o[l] = u)), t.result
            }
        },
    ...
    Bt.href = jt.href, w.extend({
        ...
        ajax: function (t, n) {
            ...
            var o, i, a, s, u, c, l, f, d, p, h = w.ajaxSetup({}, n),
                g = h.context || h,
            ...
            if (v.promise(j), h.url = ((t || h.url || jt.href) + "").replace(_t, jt.protocol + "//"), h.type = n.method || n.type || h.method || h.type, h.dataTypes = (h.dataType || "*").toLowerCase().match(q) || [""], null == h.crossDomain) {
                c = r.createElement("a");
                try {
            ...
            if (h.data && h.processData && "string" != typeof h.data && (h.data = w.param(h.data, h.traditional)), Wt(Ht, h, n, j), l) return j;
            for (d in (f = w.event && h.global) && 0 == w.active++ && w.event.trigger("ajaxStart"), h.type = h.type.toUpperCase(), h.hasContent = !qt.test(h.type), i = h.url.replace(Mt, ""), h.hasContent ? h.data && h.processData && 0 === (h.contentType || "").indexOf("application/x-www-form-urlencoded") && (h.data = h.data.replace(Lt, "+")) : (p = h.url.slice(i.length), h.data && (h.processData || "string" == typeof h.data) && (i += (kt.test(i) ? "&" : "?") + h.data, delete h.data), !1 === h.cache && (i = i.replace(Ot, "$1"), p = (kt.test(i) ? "&" : "?") + "_=" + St++ + p), h.url = i + p), h.ifModified && (w.lastModified[i] && j.setRequestHeader("If-Modified-Since", w.lastModified[i]), w.etag[i] && j.setRequestHeader("If-None-Match", w.etag[i])), (h.data && h.hasContent && !1 !== h.contentType || n.contentType) && j.setRequestHeader("Content-Type", h.contentType), j.setRequestHeader("Accept", h.dataTypes[0] && h.accepts[h.dataTypes[0]] ? h.accepts[h.dataTypes[0]] + ("*" !== h.dataTypes[0] ? ", " + Rt + "; q=0.01" : "") : h.accepts["*"]), h.headers) j.setRequestHeader(d, h.headers[d]);
            ...
            function S(t, n, r, s) {
                var c, d, p, b, T, C = n;
                l || (l = !0, u && e.clearTimeout(u), o = void 0, a = s || "", j.readyState = 0 < t ? 4 : 0, c = 200 <= t && t < 300 || 304 === t, r && (b = function (e, t, n) {
                ...
                }(h, b, j, c), c ? (h.ifModified && ((T = j.getResponseHeader("Last-Modified")) && (w.lastModified[i] = T), (T = j.getResponseHeader("etag")) && (w.etag[i] = T)), 204 === t || "HEAD" === h.type ? C = "nocontent" : 304 === t ? C = "notmodified" : (C = b.state, d = b.data, c = !(p = b.error))) : (p = C, !t && C || (C = "error", t < 0 && (t = 0))), j.status = t, j.statusText = (n || C) + "", c ? v.resolveWith(g, [d, C, j]) : v.rejectWith(g, [j, C, p]), j.statusCode(x), x = void 0, f && m.trigger(c ? "ajaxSuccess" : "ajaxError", [j, h, c ? d : p]), y.fireWith(g, [j, C]), f && (m.trigger("ajaxComplete", [j, h]), --w.active || w.event.trigger("ajaxStop")))
            }
            return j
        },
    ...
    w.ajaxSetup({
        ...
        setOffset: function (e, t, n) {
            var r, o, i, a, s, u, c = w.css(e, "position"),
                l = w(e),
                f = {};
            "static" === c && (e.style.position = "relative"), s = l.offset(), i = w.css(e, "top"), u = w.css(e, "left"), ("absolute" === c || "fixed" === c) && -1 < (i + u).indexOf("auto") ? (a = (r = l.position()).top, o = r.left) : (a = parseFloat(i) || 0, o = parseFloat(u) || 0), g(t) && (t = t.call(e, n, w.extend({}, s))), null != t.top && (f.top = t.top - s.top + a), null != t.left && (f.left = t.left - s.left + o), "using" in t ? t.using.call(e, f) : l.css(f)
        }
    }, w.fn.extend({
        offset: function (e) {
...
function (e, t) {
    ...
    function e(e, t, n, r) {
        if (n) {
            ...
            for (var a = document.importNode ? document.importNode(n, !0) : n.cloneNode(!0), s = document.createElementNS(t.namespaceURI || "http://www.w3.org/2000/svg", "g"); a.childNodes.length;) s.appendChild(a.firstChild);
            if (r)
    ...
    function t(t, n) {
        t.onreadystatechange = function () {
            if (4 === t.readyState) {
                ...
                r || ((r = t._cachedDocument = document.implementation.createHTMLDocument("")).body.innerHTML = t.responseText, t._cachedTarget = {}), t._embeds.splice(0).map(function (o) {
    ...
    return function (r) {
        var o, i, a = Object(r);
        i = a.fallback || function (e) {
            return e.replace(/\?[^#]+/, "").replace("#", ".").replace(/^\./, "") + ".png" + (/\?[^#]+/.exec(e) || [""])[0]
        }, (o = "nosvg" in a ? a.nosvg : /\bMSIE [1-8]\b/.test(navigator.userAgent)) && (document.createElement("svg"), document.createElement("use"));
        var s, u = window.top !== window.self;
        s = "polyfill" in a ? a.polyfill : /\bMSIE [1-8]\.0\b/.test(navigator.userAgent) || /\bTrident\/[567]\b|\bMSIE (?:9|10)\.0\b/.test(navigator.userAgent) || (navigator.userAgent.match(/\bEdge\/12\.(\d+)\b/) || [])[1] < 10547 || (navigator.userAgent.match(/\bAppleWebKit\/(\d+)\b/) || [])[1] < 537 || /\bEdge\/.(\d+)\b/.test(navigator.userAgent) && u;
        var c = {},
            ...
            for (var u = 0; u < f.length;) {
                ...
                if (g) {
                    ...
                    if (o) {
                        ...
                        v.style.cssText = "display:inline-block;height:100%;width:100%", v.setAttribute("width", g.getAttribute("width") || g.clientWidth), v.setAttribute("height", g.getAttribute("height") || g.clientHeight), v.src = i(m, g, p), h.replaceChild(v, p)
                    } else if (s)
                        if (!a.validate || a.validate(m, g, p)) {
                            ...
                            if (x.length) {
                                var w = c[x];
                                w || ((w = c[x] = new XMLHttpRequest).open("GET", x), w.send(), w._embeds = []), w._embeds.push({
                                    parent: h,
                                    svg: g,
                                    id: b
                                }), t(w, p)
...
function (e) {
    ...
    function t(t) {
        var a = t || window.event,
            ...
            h = 0,
            g = 0;
        if ((t = e.event.fix(a)).type = "mousewheel", "detail" in a && (d = -1 * a.detail), "wheelDelta" in a && (d = a.wheelDelta), "wheelDeltaY" in a && (d = a.wheelDeltaY), "wheelDeltaX" in a && (f = -1 * a.wheelDeltaX), "axis" in a && a.axis === a.HORIZONTAL_AXIS && (f = -1 * d, d = 0), c = 0 === d ? f : d, "deltaY" in a && (c = d = -1 * a.deltaY), "deltaX" in a && (f = a.deltaX, 0 === d && (c = -1 * f)), 0 !== d || 0 !== f) {
            if (1 === a.deltaMode) {
            ...
            if (p = Math.max(Math.abs(d), Math.abs(f)), (!i || i > p) && (i = p, r(a, p) && (i /= 40)), r(a, p) && (c /= 40, f /= 40, d /= 40), c = Math[c >= 1 ? "floor" : "ceil"](c / i), f = Math[f >= 1 ? "floor" : "ceil"](f / i), d = Math[d >= 1 ? "floor" : "ceil"](d / i), l.settings.normalizeOffset && this.getBoundingClientRect) {
                var y = this.getBoundingClientRect();
                h = t.clientX - y.left, g = t.clientY - y.top
            }
            return t.deltaX = f, t.deltaY = d, t.deltaFactor = i, t.offsetX = h, t.offsetY = g, t.deltaMode = 0, s.unshift(t, c, f, d), o && clearTimeout(o), o = setTimeout(n, 200), (e.event.dispatch || e.event.handle).apply(this, s)
        }
    }
...
function (e) {
    ...
    function o(t) {
        return r(t) || e.isPlainObject(t) ? t : {
            top: t,
            left: t
        }
    }
    return t.defaults = {
        ...
        "object" == typeof a && (s = a, a = 0), "function" == typeof s && (s = {
            onAfter: s
        }), "max" === i && (i = 9e9), s = e.extend({}, t.defaults, s), a = a || s.duration;
        var u = s.queue && s.axis.length > 1;
        return u && (a /= 2), s.offset = o(s.offset), s.over = o(s.over), this.each(function () {
            if (null !== i) {
                var c, l = n(this),
                ...
                e.each(s.axis.split(""), function (e, n) {
                    var r = "x" === n ? "Left" : "Top",
                        ...
                        a = d[i](),
                        v = t.max(f, n);
                    if (c) h[i] = c[o] + (l ? 0 : a - d.offset()[o]), s.margin && (h[i] -= parseInt(p.css("margin" + r), 10) || 0, h[i] -= parseInt(p.css("border" + r + "Width"), 10) || 0), h[i] += g[o] || 0, s.over[o] && (h[i] += p["x" === n ? "width" : "height"]() * s.over[o]);
                    else {
                        var y = p[o];
                        h[i] = y.slice && "%" === y.slice(-1) ? parseFloat(y) / 100 * v : y
                    }
                    s.limit && /^\d+$/.test(h[i]) && (h[i] = h[i] <= 0 ? 0 : Math.min(h[i], v)), !e && s.axis.length > 1 && (a === h[i] ? h = {} : u && (m(s.onAfterFirst), h = {}))
                }), m(s.onAfter)
            }
...
function (e, t) {
    ...
    function c(e, t) {
        var n = u(e),
            i = o(s.und(n[0]) ? 1 : n[0], .1, 100),
            a = o(s.und(n[1]) ? 100 : n[1], .1, 100),
            c = o(s.und(n[2]) ? 10 : n[2], .1, 100),
            l = o(s.und(n[3]) ? 0 : n[3], .1, 100),
            f = Math.sqrt(a / i),
            d = c / (2 * Math.sqrt(a * i)),
        ...
        function m(e) {
            var n = t ? t * e / 1e3 : e;
            return n = d < 1 ? Math.exp(-n * d * f) * (h * Math.cos(p * n) + g * Math.sin(p * n)) : (h + g * n) * Math.exp(-n * f), 0 === e || 1 === e ? e : 1 - n
        }
        return t ? m : function () {
            var t = r.springs[e];
            if (t) return t;
    ...
    var f, d, p = function () {
            ...
            return function (n, r, o, s) {
                if (0 <= n && n <= 1 && 0 <= o && o <= 1) {
                    ...
                    if (n !== r || o !== s)
                        for (var c = 0; c < e; ++c) u[c] = i(c * t, n, o);
                    return function (e) {
                        return n === r && o === s ? e : 0 === e || 1 === e ? e : i(l(e), r, s)
                    }
                }

                function l(r) {
                    for (var s = 0, c = 1, l = e - 1; c !== l && u[c] <= r; ++c) s += t;
                    var f = s + (r - u[--c]) / (u[c + 1] - u[c]) * t,
                        d = a(f, n, o);
                    return d >= .001 ? function (e, t, n, r) {
                        ...
                        for (var a, s, u = 0;
                            (a = i(s = t + (n - t) / 2, r, o) - e) > 0 ? n = s : t = s, Math.abs(a) > 1e-7 && ++u < 10;);
                        return s
                    }(r, s, s + t, n, o)
                }
            }
    ...
    function D(e, t) {
        return s.dom(e) && !s.inp(e) && (k(e, t) || s.svg(e) && e[t]) ? "attribute" : s.dom(e) && b(n, t) ? "transform" : s.dom(e) && "transform" !== t && A(e, t) ? "css" : null != e[t] ? "object" : void 0
    }
        ...
        switch (D(e, t)) {
            case "transform":
                return function (e, t, n, r) {
                    var o, a = i(t, "scale") ? 1 : 0 + (i(o = t, "translate") || "perspective" === o ? "px" : i(o, "rotate") || i(o, "skew") ? "deg" : void 0),
                        s = N(e).get(t) || a;
    ...
    function M(e, t) {
        if (s.col(e)) return function (e) {
            return s.rgb(e) ? (n = /rgb\((\d+,\s*[\d]+,\s*[\d]+)\)/g.exec(t = e)) ? "rgba(" + n[1] + ",1)" : t : s.hex(e) ? (r = e.replace(/^#?([a-f\d])([a-f\d])([a-f\d])$/i, function (e, t, n, r) {
                return t + t + n + n + r + r
            }), o = /^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(r), "rgba(" + parseInt(o[1], 16) + "," + parseInt(o[2], 16) + "," + parseInt(o[3], 16) + ",1)") : s.hsl(e) ? function (e) {
    ...
    function F(e, t) {
        ...
        return o.map(function (e, n) {
            ...
            return s.und(r.delay) && (r.delay = n ? 0 : t.delay), s.und(r.endDelay) && (r.endDelay = n === o.length - 1 ? t.endDelay : 0), r
        }).map(function (e) {
            return C(e, n)
        })
    }
                        ...
                        var r = function (e, t) {
                                ...
                                return e.tweens.map(function (r) {
                                    var o = function (e, t) {
                                        ...
                                        d = j(f) || j(c),
                                        p = u || d;
                                    return s.und(a) && (a = l), o.from = I(f, p), o.to = I(L(a, f), p), o.start = n ? n.end : 0, o.end = o.start + o.delay + o.duration + o.endDelay, o.easing = g(o.easing, o.duration), o.isPath = s.pth(i), o.isColor = s.col(o.from.original), o.isColor && (o.round = 1), n = o, o
                                })
                            }(t, e),
                            o = r[r.length - 1];
                        return {
    ...
    function K(n) {
        ...
        var f, d, p, h, g, m, y, x, b = (d = T(e, f = n), h = W(p = T(t, f), f), y = V(m = U(g = B(f.targets), h), p), x = Q, Q++, C(d, {
            id: x,
            children: [],
            animatables: g,
            animations: m,
        ...
        function w() {
            var e = b.direction;
            "alternate" !== e && (b.direction = "normal" !== e ? "normal" : "reverse"), b.reversed = !b.reversed, r.forEach(function (e) {
        ...
        function E(e) {
            for (var t = 0, n = b.animations, r = n.length; t < r;) {
                ...
                for (var l = o(e - c.start - c.delay, 0, c.duration) / c.duration, f = isNaN(l) ? 1 : c.easing(l), d = c.to.strings, p = c.round, h = [], g = c.to.numbers.length, m = void 0, y = 0; y < g; y++) {
                    var x = void 0,
                        w = c.to.numbers[y],
                        T = c.from.numbers[y] || 0;
                    x = c.isPath ? H(c.value, f * w) : T + f * (w - T), p && (c.isColor && y > 2 || (x = Math.round(x * p) / p)), h.push(x)
                }
                var C = d.length;
                if (C) {
                    m = d[0];
        ...
        function D(e) {
            var t = b.duration,
                ...
                f = t - b.endDelay,
                d = j(e);
            b.progress = o(d / t * 100, 0, 100), b.reversePlayback = d < b.currentTime, r && function (e) {
                if (b.reversePlayback)
                    for (var t = u; t--;) k(e, r[t]);
                else
                    for (var n = 0; n < u; n++) k(e, r[n])
            }(d), !b.began && b.currentTime > 0 && (b.began = !0, A("begin")), !b.loopBegan && b.currentTime > 0 && (b.loopBegan = !0, A("loopBegin")), d <= n && 0 !== b.currentTime && E(0), (d >= f && b.currentTime !== t || !t) && E(t), d > n && d < f ? (b.changeBegan || (b.changeBegan = !0, b.changeCompleted = !1, A("changeBegin")), A("change"), E(d)) : b.changeBegan && (b.changeCompleted = !0, b.changeBegan = !1, A("changeComplete")), b.currentTime = o(d, 0, t), b.began && A("update"), e >= t && (a = 0, b.remaining && !0 !== b.remaining && b.remaining--, b.remaining ? (i = s, A("loopComplete"), b.loopBegan = !1, "alternate" === b.direction && w()) : (b.paused = !0, b.completed || (b.completed = !0, A("loopComplete"), A("complete"), !b.passThrough && "Promise" in window && (c(), l(b)))))
        }
        return l(b), b.reset = function () {
            var e = b.direction;
            b.passThrough = !1, b.currentTime = 0, b.progress = 0, b.paused = !0, b.began = !1, b.loopBegan = !1, b.changeBegan = !1, b.completed = !1, b.changeCompleted = !1, b.reversePlayback = !1, b.reversed = "reverse" === e, b.remaining = b.loop, r = b.children;
            for (var t = u = r.length; t--;) b.children[t].reset();
            (b.reversed && !0 !== b.loop || "alternate" === e && 1 === b.loop) && b.remaining++, E(b.reversed ? b.duration : 0)
        }, b.set = function (e, t) {
            return X(e, t), b
        }, b.tick = function (e) {
    ...
    return "undefined" != typeof document && document.addEventListener("visibilitychange", function () {
        document.hidden ? (G.forEach(function (e) {
            return e.pause()
        }), J = G.slice(0), K.running = G = []) : J.forEach(function (e) {
            return e.play()
        })
    }), K.version = "3.2.0", K.speed = 1, K.running = G, K.remove = function (e) {
    ...
    }, K.get = $, K.set = X, K.convertPx = E, K.path = function (e, t) {
        ...
        void 0 === e && (e = {});
        var n = K(e);
        return n.duration = 0, n.add = function (r, o) {
            var i = G.indexOf(n),
                a = n.children;
            ...
            var f = n.duration;
            l.autoplay = !1, l.direction = n.direction, l.timelineOffset = s.und(o) ? f : L(o, f), u(n), n.seek(l.timelineOffset);
            var d = K(l);
            u(d), a.push(d);
            var p = V(a, e);
            return n.delay = p.delay, n.endDelay = p.endDelay, n.duration = p.duration, n.seek(0), n.reset(), n.autoplay && n.play(), n
        }, n
    }, K.easing = g, K.penner = h, K.random = function (e, t) {
        return Math.floor(Math.random() * (t - e + 1)) + e
    }, K
}), $(document).ready(function () {
    svg4everybody(), touchOrNot(), invertHorScroll(), initPlayers(), handleProject(), siteInfos(), updateTime(), setInterval(updateTime, 1e3), onScroll(), igBrowser(), setTimeout(function () {
        $(".site-infos").css("opacity", 1)
    }, 310)
